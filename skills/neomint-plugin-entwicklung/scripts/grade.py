#!/usr/bin/env python3
"""grade.py — Contract grader for the neomint-plugin-entwicklung (governance) skill.
...
def main() -> int:
    ...
    if failures:
        print("FAIL neomint-plugin-entwicklung grader:")
        for f in failures:
            print(f"  - {f}")
        return 1
    print("PASS neomint-plugin-entwicklung grader — governance contract intact")
    return 0
